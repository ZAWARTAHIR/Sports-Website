...
const teams = [
  {
    ...
    classes: ["BSCS-8", "ADCS-5"],
    in: ["Prof. M.Ali", "Miss Amna Awan", "Miss Warda"],
  },
  {
    name: "Hawks",
    logo: "/hawks.png", 
    ...
    classes: ["BSCS-7", "BBA-8", "BSAF-2", "ADAF-9"],
    in: ["Prof. Ashir Ashfaq", "Prof. Badar Chishti", "Miss Hira"],
  },
  {
    name: "Falcons",
    logo: "/falcon.png", 
  ...
  
  {
    ...
    classes: ["BSCS-6", "BBA-7", "ADCS-4", "BSCS-F1"],
    in: ["Prof. Rana Hammad Habib", "Prof. Farooq Qaiser"],
  },
  {
    name: "Gladiators",
    logo: "/gladiators.png", 
              ...
              <div className="card shadow-sm">
                <div className="card-body">
                  <div className="text-center mb-3">
                    <img
                      src={team.logo} // Direct image path from public folder
                      alt={team.name}
                      className="img-fluid"
